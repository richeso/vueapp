package com.mapr.vueapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.mapr.vueapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.mapr.vueapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
