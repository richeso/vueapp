<template>
  <b-navbar data-cy="navbar" toggleable="md" type="dark" class="bg-dark">
    <b-navbar-brand class="logo" b-link to="/">
      ...
      <span v-text="$t('global.title')" class="navbar-title">vueapp</span> <span class="navbar-version">{{ version }}</span>
    </b-navbar-brand>
    <b-navbar-toggle
      right
    ...
    <b-collapse is-nav id="header-tabs">
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item-dropdown right id="entity-menu" v-if="authenticated" active-class="active" class="pointer" data-cy="entity">
          ...
          <b-dropdown-item to="/code-tables">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.codeTables')">Code Tables</span>
          </b-dropdown-item>
          <b-dropdown-item to="/code-values">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.codeValues')">Code Values</span>
          </b-dropdown-item>
